  ...
  <div class="bg-white px-3" style="margin: -20px;margin-top: -1rem;margin-bottom: 0!important;">
    <el-tabs v-model="preURL" @tab-click="getList">
      ...
      <el-tab-pane label="角色列表" name="role">
        <div class="d-flex align-items-center">
          <el-button type="primary" size="mini"
                     v-auth="'添加角色'" @click="openDialog('role')">添加角色
          </el-button>
        </div>
        <el-table border class="mt-3"
                  :data="roleList"
      ...
      <el-tab-pane label="权限列表" name="rule">
        <div class="d-flex align-items-center">
          <el-button type="primary" size="mini"
                     v-auth="'添加规则'" @click="openDialog('rule')">添加规则
          </el-button>
        </div>
        ...
        <el-tree :data="ruleList" :props="defaultProps" @node-click="handleNodeClick"
          ...
          <div class="custom-tree-node"
               slot-scope="{ node, data }" style="width: 100%;">
            ...
            <span class="ml-auto d-flex align-items-center">
              ...
              <el-button type="text" size="mini"
                         @click="openDialog('rule',data.id)" v-auth="'添加规则'">增加
              </el-button>
    ...
    <el-dialog
      ...
      <el-form v-if="preURL ==='manager' " ref="form" :model="form.manager" label-width="80px">
        ...
        <el-form-item label="头像">
          <div>
            ...
            <img v-else :src="form.manager.avatar" class="rounded" style="width: 45px;height: 45px;cursor: pointer;"
                 @click="chooseImage"/>
          </div>
        </el-form-item>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button
		    ...
		    <el-button
            type="primary" @click="submit">确 定</el-button>
		  </span>
    </el-dialog>
    <!-- 配置权限 -->
    <el-drawer
